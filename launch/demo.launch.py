...
def generate_launch_description():
    ...
    robot_description_semantic_config = load_file(
        "dvrk_psm_moveit2_config", "config/dvrk_psm.srdf"
    )
    ...
    kinematics_yaml = load_yaml(
        "dvrk_psm_moveit2_config", "config/kinematics.yaml"
    )
    ...
    ompl_planning_yaml = load_yaml(
        "dvrk_psm_moveit2_config", "config/ompl_planning.yaml"
    )
    ...
    rviz_base = os.path.join(get_package_share_directory("dvrk_psm_moveit2_config"), "launch")
